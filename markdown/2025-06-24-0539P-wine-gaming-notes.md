...
### Hollow Knight: Silksong on Steam Deck
...
**Note** This may no longer apply on Silksong Patch 4 (1.0.28954) as that updates the input controller.
...
This is due to the game having a broken FSR implementation that conflicts with DLSS.
