...
- !Languages: C# **[Knit](https://codeberg.org/neptuwunium/Knit)**: Granny3D Version 2 Decoder
...
- !Languages: C# **[Atlantidyne](https://github.com/neptuwunium/Atlantidyne)**: No Man's Sky (HelloGames Engine) Asset Uncooker
...
### Appendix A: Project State

This is a smaller version of the planning/TODO documents I have for each project in my digital garden.
...
Note: blender addon not suitable due ID based references.
...
- Rewrite to Rust
- Fix Overlay
- Add more fun stuff to the overlay
